...
public class KubernetesClientProvider implements FieldInstanceProvider {
    ...
    public KubernetesClient createInstance(Object testInstance, Field field) {
        ...
        int requestTimeout = resolveIntValue(testInstance, field, Client.class, Client::requestTimeout);
        int websocketPingInterval = resolveIntValue(testInstance, field, Client.class, Client::websocketPingInterval);
        int watchReconnectInterval = resolveIntValue(testInstance, field, Client.class, Client::watchReconnectInterval);
